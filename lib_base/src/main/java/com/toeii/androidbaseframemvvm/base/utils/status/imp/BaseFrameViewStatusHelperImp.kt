package com.toeii.androidbaseframemvvm.base.utils.status.imp
...
open class BaseFrameViewStatusHelperImp(parentViewStatusHelper: ViewStatusHelper? = null) : ViewStatusHelper(parentViewStatusHelper) {
     ...
     */
    private val KEY_RECREATE = "com.toeii.androidbaseframemvvm.base.utils.status.BaseFrameViewStatusHelperImp.Recreate"
